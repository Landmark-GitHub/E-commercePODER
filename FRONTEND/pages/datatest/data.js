const dataTest = [
  ...
  },
  {
    ...
    price: 5400,
    description:
      "รองเท้าผ้าใบ New Balance 550 เป็นรุ่นที่ผสมผสานความคลาสสิกและความทันสมัยเข้าด้วยกัน ดีไซน์ได้รับแรงบันดาลใจจากรุ่น 99X ที่โด่งดังของ New Balance มีส่วนโค้งเว้าบนตัวรองเท้าที่ได้รับแรงบันดาลใจจากยุค Y2K พื้นรองเท้าชั้นกลางแบบ ABZORB และ SBS ช่วยให้การรองรับแรงกระแทกและการคืนพลังที่ดี พื้นรองเท้าชั้นนอกทำจากยางทนทาน เหมาะสำหรับสวมใส่ทั้งลำลองและออกกำลังกาย",
    type: "Shoes",
    brand: "New Balance",
    quantity: 10,
    sday: "01.04.2024",
...
async function getProductById(id) {
  try {
    ...
    jsonData.find((product) => product.id === id);
    return jsonData 
  } catch (error) {
    console.error("Error fetching data:", error);
  }
